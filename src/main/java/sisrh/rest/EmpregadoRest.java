...
public class EmpregadoRest {
	...
	@Path("/ativos")
	@Produces(MediaType.APPLICATION_JSON)
	public Response empregadosAtivos() throws Exception {
		List<Empregado> lista = Banco.empregadosAtivos();		
		GenericEntity<List<Empregado>> entity = new GenericEntity<List<Empregado>>(lista) {};
		return Response.ok().entity(entity).build();
	}
	...
	@Path("/inativos")
	@Produces(MediaType.APPLICATION_JSON)
	public Response empregadosInativos() throws Exception {
		List<Empregado> lista = Banco.empregadosInativos();		
		GenericEntity<List<Empregado>> entity = new GenericEntity<List<Empregado>>(lista) {};
		return Response.ok().entity(entity).build();
	}
